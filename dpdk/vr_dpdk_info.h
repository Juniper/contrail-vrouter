...
#define VR_DPDK_INFO_FN_ARGS char *buff, int len, int pos, int bufsz, int *outbuf_len

#define VR_DPDK_INFO_PASS_ARGS  buff, len, pos, bufsz, outbuf_len

#define VR_DPDK_INFO_DEC() \
