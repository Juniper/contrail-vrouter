...
void vr_uvhost_client_force_stop(vr_uvh_client_t *vru_cl);
int vr_uvhost_client_check_start(vr_uvh_client_t *vru_cl);
int vr_uvhost_client_check_stop(vr_uvh_client_t *vru_cl);
