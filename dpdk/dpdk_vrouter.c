...
#define VR_LOG_DEFAULT_LEVEL_OPT    "vr_default_log_level"
    VR_LOG_DEFAULT_LEVEL_OPT_INDEX,
#define VR_LOG_DEFAULT_SIZE_OPT     "vr_default_log_size"
    VR_LOG_DEFAULT_SIZE_OPT_INDEX,
    MAX_OPT_INDEX
};
...
extern unsigned int vr_default_log_size;
extern int vr_default_log_level;
...
dpdk_argv_update(void)
{
    ...
    RTE_LOG(INFO, VROUTER, "Log Enable:                  %" PRIu32 "\n",
		vr_logger_en);
    RTE_LOG(INFO, VROUTER, "Log default level:           %" PRIu32 "\n",
                vr_default_log_level);
    RTE_LOG(INFO, VROUTER, "Log default size:            %" PRIu32 "\n",
                vr_default_log_size);
...
static struct option long_options[] = {
    ...
    [VR_LOG_ENABLE_OPT_INDEX]       =   {VR_LOG_ENABLE_OPT, required_argument,
						    NULL,                   0},
    [VR_LOG_DEFAULT_LEVEL_OPT_INDEX] =   {VR_LOG_DEFAULT_LEVEL_OPT, required_argument,
                                                    NULL,                   0},
    [VR_LOG_DEFAULT_SIZE_OPT_INDEX] =   {VR_LOG_DEFAULT_SIZE_OPT, required_argument,
                                                    NULL,                   0},
...
Usage(void)
{
	...
	"    --"PKT_DROP_LOG_BUFFER_SIZE_OPT" NUM Maximum debug log buffer size\n"
        ...
        "    --"VR_LOG_DEFAULT_LEVEL_OPT" Default log leve\n"
        "    --"VR_LOG_DEFAULT_SIZE_OPT" Default log size\n"
        );
