...
unsigned int vr_dpdk_yield_option = 1;
...
dpdk_argv_update(void)
{
    ...
    if (vr_service_core_mask != 0) {
        service_core_mask_ptr = vr_core_mask_util(vr_service_core_mask, service_core_mask_str);
    ...
    if (vr_dpdk_ctrl_thread_mask != 0) {
        dpdk_ctrl_thread_mask_ptr = vr_core_mask_util(vr_dpdk_ctrl_thread_mask, dpdk_ctrl_thread_mask_str);
    }
