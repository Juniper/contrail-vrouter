...
int vr_dpdk_set_ring_callfd(unsigned int vif_idx, unsigned int vring_idx,
                            int callfd);
int vr_dpdk_virtio_ready_set(unsigned int vif_idx, unsigned int vring_idx,
                            vq_ready_state_t ready);
bool vr_dpdk_virtio_is_ready(unsigned int vif_idx, unsigned int vring_idx);
bool vr_dpdk_virtio_can_start(unsigned int vif_idx, unsigned int vring_idx);
