...
MODULE_PARM_DESC(vr_mpls_labels, "Number of entries in the labels table. Default is "__stringify(VR_DEF_LABELS));
module_param(vr_nexthops, uint, S_IRUGO);
MODULE_PARM_DESC(vr_nexthops, "Number of entries in the nexhops table. Default is "__stringify(VR_DEF_NEXTHOPS));
module_param(vr_vrfs, uint, S_IRUGO);
MODULE_PARM_DESC(vr_vrfs, "Number of entries in the vrfs table. Default is "__stringify(VR_DEF_VRFS));
module_param(vr_flow_hold_limit, uint, S_IRUGO);
MODULE_PARM_DESC(vr_flow_hold_limit, "Number of outstanding flow entries in the flow table. Default is 8192");
