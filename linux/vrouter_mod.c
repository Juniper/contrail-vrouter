...
static struct ctl_table vrouter_table[] =
{
    ...
    {
	.procname       = "log_mod_sizes",
	.data           = &sizes,
	.maxlen         = sizeof(unsigned int)*VR_NUM_MODS,
	.mode           = 0644,
	.proc_handler   = proc_dointvec,
    },
    {
...
//----
module_param(sizes, uint, S_IRUGO);
MODULE_PARM_DESC(sizes, "Give size of module logs at load time");
