...
module_param(vr_config_drop_stats_log_buffer_enable,uint, S_IRUGO);
MODULE_PARM_DESC(vr_config_drop_stats_log_buffer_enable,"Enable/Disable vrouter dropstats log support");
#endif
