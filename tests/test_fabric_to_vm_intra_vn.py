...
class TestFabricToVmIntraVn(unittest.TestCase):
    ...
    def test_hbs_fabric_to_vmi(self):
        ...
        self.vif_nh.nhr_flags = constants.NH_FLAG_POLICY_ENABLED |\
            constants.NH_FLAG_ETREE_ROOT |\
            constants.NH_FLAG_VALID
        self.vif_nh.sync()

        self.underlay_rnh.nhr_flags = constants.NH_FLAG_RELAXED_POLICY |\
            constants.NH_FLAG_ETREE_ROOT |\
            constants.NH_FLAG_VALID
        self.underlay_rnh.sync()

        self.underlay_route.rtr_label_flags = constants.VR_RT_ARP_TRAP_FLAG
        self.underlay_route.sync()

        self.l2_nh.nhr_flags = constants.NH_FLAG_POLICY_ENABLED |\
            constants.NH_FLAG_ETREE_ROOT |\
            constants.NH_FLAG_VALID
        self.l2_nh.sync()
        ...
        self.tunnel_nh.nhr_flags = constants.NH_FLAG_TUNNEL_UDP_MPLS |\
            constants.NH_FLAG_ETREE_ROOT
        self.tunnel_nh.sync()
