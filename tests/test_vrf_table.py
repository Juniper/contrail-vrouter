...
class TestVrfTable(unittest.TestCase, vtest_common.VTestCommon):
    ...
    def test_vrf_table_new(self):
        # Add hbs-l vif 
        vif = VirtualVif(idx=3, name="tap1589a2b3-22", ipv4_str="100.100.100.4", 
                        mac_str="00:00:5e:00:01:00", vrf=3,
        ...
        # Add hbs-r vif
        vif = VirtualVif(idx=4, name="tap8b05a86b-36", ipv4_str="200.200.200.4",
                        mac_str="00:00:5e:00:01:00", vrf=4,
        ...
        # Add hbs-l and hbs-r
        vrf = Vrf(0, 5, vtconst.VRF_FLAG_HBS_L_VALID | vtconst.VRF_FLAG_HBS_R_VALID,
                vrf_hbfl_vif_idx=3, vrf_hbfr_vif_idx=4)
        vrf.delete()

        # Remove hbs-l and hbs-r in vrf table
        vrf = Vrf(0, 5, vtconst.VRF_FLAG_HBS_R_VALID | vtconst.VRF_FLAG_HBS_R_VALID, 
                vrf_hbfl_vif_idx=-1, vrf_hbfr_vif_idx=-1)
        vrf.sync()
