...
logfile = os.path.realpath(os.environ.get('PWD') + \
...
def parse(cmd):
    ...
    pylib_path = tests_path  + '/../utils/pylib'
    ...
    if args['all']:
        ...
        cmd = 'pycodestyle {}/* {}/test_*'.format(pylib_path, tests_path)
    elif args['flake']:
        logging.info("Running flake check ..")
        cmd = 'flake8 {}/* {}/test_*'.format(pylib_path, tests_path)
    else:
