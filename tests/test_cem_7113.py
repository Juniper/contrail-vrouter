...
class Test_CEM_7113(unittest.TestCase):
    ...
    def test_cem_7113(self):
        ...
        tenant_vif = VirtualVif(
            ...
            mcast_vrf=2,
            flags=(
                constants.VIF_FLAG_POLICY_ENABLED | constants.VIF_FLAG_DHCP_ENABLED))
        ...
        tenant_vif_nh = EncapNextHop(
            ...
            nh_vrf=2,
            nh_flags=(
                constants.NH_FLAG_VALID | constants.NH_FLAG_POLICY_ENABLED),
        ...
        receive_nh = ReceiveNextHop(
            encap_oif_id=vhost_vif.idx(), nh_vrf=1, nh_id=10, nh_flags=(
                constants.NH_FLAG_VALID | constants.NH_FLAG_RELAXED_POLICY))

        # Add fabric Route
        fabric_route = InetRoute(
            vrf=0,
            prefix="8.0.0.3",
            nh_id=receive_nh.idx(),
