...
class TestHbsRightVmToLeftVmIntraVn(unittest.TestCase):
    ...
    def test_hbs_right_vm_to_left_vm_intra_vn(self):
        ...
        # send ping request from tenant_vif4
        icmp = IcmpPacket(
            sip='1.1.1.5',
            dip='1.1.1.4',
        ...
        # send encoded packet from hbs-l and receive on tenant_vif3
        icmp = IcmpPacket(
            sip='1.1.1.5',
            dip='1.1.1.4',
            smac='02:e7:03:ea:67:f1',
        ...
        # Check if the packet was sent on tenant_vif4 and received at
        # tenant_vif3
        self.assertEqual(1, tenant_vif4.get_vif_ipackets())
        self.assertEqual(1, tenant_vif3.get_vif_opackets())
