...
struct diet_object_md diet_md[] = {
    ...
    [VR_DROP_STATS_FILTER_OBJECT_ID] = {
        .obj_len                     =  sizeof(vr_drop_stats_filter_req),
...
{
    vr_drop_stats_filter_req *src = (vr_drop_stats_filter_req *)object;
    if (buf_len < diet_md[VR_DROP_STATS_FILTER_OBJECT_ID].obj_len)
        return -ENOSPC;
