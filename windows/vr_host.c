...
{
    // The following ifdef is a workaround for `uninitialized local variable 'args' used`
#ifdef CMOCKA_UNIT_TESTING
    return 0;
#else
    int printed;
    va_list args;
...
cleanup_both_nbls:
    FreeClonedNetBufferList(rightNbl);

cleanup_nbl:
    FreeClonedNetBufferList(leftNbl);
...
struct host_os windows_host = {
    ...
    .hos_palloc = NULL,
    .hos_pfree = win_pfree,
    .hos_palloc_head = NULL,
    .hos_pexpand_head = NULL,
    .hos_preset = NULL,
    ...
    .hos_get_cpu = NULL,
    .hos_schedule_work = NULL,
    .hos_delay_op = NULL,
    .hos_defer = NULL,
    .hos_get_defer_data = NULL,
    .hos_put_defer_data = NULL,
    .hos_get_time = NULL,
    .hos_get_mono_time = NULL,
    .hos_create_timer = NULL,
    .hos_delete_timer = NULL,

    .hos_network_header = NULL,
    .hos_inner_network_header = NULL,
    .hos_data_at_offset = NULL,
    .hos_pheader_pointer = NULL,
    .hos_pull_inner_headers = NULL,
    .hos_pcow = NULL,
    .hos_pull_inner_headers_fast = NULL,
    .hos_get_udp_src_port = NULL,
    .hos_pkt_from_vm_tcp_mss_adj = NULL,
    .hos_pkt_may_pull = NULL,
    .hos_gro_process = NULL,
    .hos_enqueue_to_assembler = NULL,
    .hos_set_log_level = NULL,
    .hos_set_log_type = NULL,
    .hos_get_log_level = NULL,
    .hos_get_enabled_log_types = NULL,
    .hos_soft_reset = NULL,
    .hos_register_nic = NULL,
};
#else
struct host_os windows_host = {
