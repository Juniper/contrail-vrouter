...
/* Size of direc mbuf used for fragmentation */
#define VR_DPDK_FRAG_DIRECT_MBUF_SZ     (sizeof(struct rte_mbuf)    \
                                         + RTE_PKTMBUF_HEADROOM)
/* Size of indirect mbufs used for fragmentation */
...
#define VR_DPDK_FRAG_DIRECT_MEMPOOL_SZ     2048
/* How many objects (mbufs) to keep in per-lcore FRAG_DIRECT mempool cache */
#define VR_DPDK_FRAG_DIRECT_MEMPOOL_CACHE_SZ    (VR_DPDK_RX_BURST_SZ*4)
