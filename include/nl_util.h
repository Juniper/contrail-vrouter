...
struct nl_sandesh_callbacks {
    ...
    void (*vr_dpdk_info_req_process)(void *);
...
extern int vr_send_dpdkutils_dump(struct nl_client *cl, unsigned int router_id,
        int marker, int inst_id, dpdkinfo_msginfo msginfo);
