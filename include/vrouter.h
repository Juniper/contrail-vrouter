...
#ifdef _WIN32
	/* Packet drop log feature is not supported in windows */
	#define VR_PKT_DROP_LOG_BUFFER_INFRA STD_OFF
#else
	/* Enable packet drop log buffer infra */
	#define VR_PKT_DROP_LOG_BUFFER_INFRA STD_ON
#endif
