...
#define VR_FLOW_DR_NO_SRC_ROUTE_L2RPF     0x12
#define VR_FLOW_DR_POLICY                 0x13
#define VR_FLOW_DR_OUT_POLICY             0x14
#define VR_FLOW_DR_SG                     0x15
#define VR_FLOW_DR_OUT_SG                 0x16
#define VR_FLOW_DR_REVERSE_SG             0x17
#define VR_FLOW_DR_REVERSE_OUT_SG         0x18
...
int vr_inet6_get_flow_key(struct vrouter *, unsigned short, struct vr_packet *,
        uint16_t, struct vr_flow *, uint8_t, bool);
...
extern int vr_inet_get_flow_key(struct vrouter *, struct vr_packet *,
        struct vr_forwarding_md *, struct vr_flow *, uint8_t, bool);
