...
enum vr_assembler_action {
    VR_ASSEMBLER_ACTION_ENQUEUE,
    VR_ASSEMBLER_ACTION_DATA
};
...
int vr_fragment_enqueue(struct vrouter *, struct vr_fragment_queue_element **,
        unsigned int, struct vr_packet *, struct vr_forwarding_md *);
