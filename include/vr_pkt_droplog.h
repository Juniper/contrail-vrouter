...
#define DROP_RSN_MAP(X) \
    ...
    X(VP_DROP_FRAG_STALE) \
    X(VP_DROP_FRAG_NON_HEAD) \
    X(VP_DROP_FRAG_MAX_PER_CPU) \
    X(VP_DROP_FRAG_MAX_ALLCPU_CORE) \
    X(VP_DROP_FRAG_MEM_ALLOC) \
    X(VP_DROP_FRAG_ENQUEUE_FAIL) \
    X(VP_DROP_FRAG_CPU) \
    X(VP_DROP_FRAG_CPU_EXCEED) \
