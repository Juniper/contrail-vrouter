...
void vr_pkt_drop_stats_log_func(unsigned short drop_reason, struct vr_packet *pkt, struct vr_flow *flow, unsigned short drop_loc_file_id, unsigned int drop_loc_line_id);
#if 0 
{
    int cpu = vr_get_cpu();
