...
struct vr_host_interface_ops {
    ...
    void (*hif_stats_update)(struct vr_interface *, unsigned int, int, struct vr_interface_stats *);
    int (*hif_get_slaves_info)(struct vr_interface *, unsigned int, struct vr_bond_slaves_info *);
};
