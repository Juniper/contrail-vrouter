...
def test_hbs_fabric_to_vmi_inter_vn(vrouter_test_fixture):

    vt = vtest("test_hbs_fabric_to_vmi_inter_vn")
    ...
    ip_inner = IP(version=4, ihl=5, id=1, ttl=64, proto='icmp', src='2.2.2.3', dst='1.1.1.3')
    icmp = ICMP(type=0, code=0, id=4145)
    pkt = eth_outer/ip_outer/udp_outer/mpls/ip_inner/icmp
    pkt.show()
    ...
    eth = Ether(dst='c0:d2:00:06:08:f0', src='00:00:5e:00:01:00', type=0x800)
    ip = IP(version=4, ihl=5, id=1, ttl=64, proto='icmp', src='2.2.2.3', dst='1.1.1.3')
    icmp = ICMP(type=0, code=0, id=4145)
    pkt = eth/ip/icmp
    pkt.show()
