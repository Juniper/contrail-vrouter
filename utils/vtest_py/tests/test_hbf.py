...
def test_hbf(vrouter_test_fixture):
    ...
    vif.vifr_vrf = 0
    vif.vifr_mac = vtest_mac("00:1b:21:bb:f9:48")
    vif.vifr_mtu = 1514
    vif.vifr_ip = vtest_ipv4("8.0.0.2")
   ...
   # Add hbf-l vif
    ...
    vif.vifr_vrf = 3
    vif.vifr_mac = vtest_mac("00:00:5e:00:01:00")
    vif.vifr_mtu = 1514
    vif.vifr_ip = vtest_ipv4("100.100.100.4")
    ...
    vif.vifr_mac = vtest_mac("00:00:5e:00:01:00")
    vif.vifr_mtu = 1514
    vif.vifr_ip = vtest_ipv4("200.200.200.4")
    ...
    vif.vifr_mac = vtest_mac("00:00:5e:00:01:00")
    vif.vifr_mtu = 1514
    vif.vifr_ip = vtest_ipv4("1.1.1.3")
    ...
    nh.nhr_encap = vtest_encap("00 1b 21 bb f9 46 00 1b 21 bb f9 48 08 00")
    nh.nhr_tun_sip = vtest_ipv4("8.0.0.2")
    nh.nhr_tun_dip = vtest_ipv4("8.0.0.3")
    nh.nhr_vrf = 0
    ...
    route.rtr_nh_id = 21
    route.rtr_mac = vtest_mac("02:e7:03:ea:67:f1")
    route.rtr_label = 27
    route.rtr_vrf_id = 5
    ...
    vt.send_recv_pkt(pkt, "tapc2234cd0-55", pkt, "1")
