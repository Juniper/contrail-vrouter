...
def test_hbs_vmi_to_fabric(vrouter_test_fixture):

    vt = vtest("test_hbs_vmi_to_fabric")
   ...
   # Add hbs-l vif
    ...
    # Make sure the packet comes goes to hbs-l (tap1589a2b3-22)
    ...
    vt.send_recv_pkt(pkt, "tap8b05a86b-36", pkt, "eth0")

    # Check if the packet was sent to vrouter (by vtest) on vif5
