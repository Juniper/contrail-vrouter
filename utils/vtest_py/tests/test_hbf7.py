...
def test_hbf_vm_to_vm_inter_vn(vrouter_test_fixture):

    vt = vtest("test_hbf_vm_to_vm_inter_vn")
   ...
   # Add hbf-l vif
    ...
    # pkt from hbf-r to vif 3 will need a lookup of dst-mac in the bridge table
    ...
    # send ping request from vif3 and receive in hbf-l
    ...
    # send ping request from hbf-r and receive in vif4
    ...
    # send ping response from vif4 and receive in hbf-r
    ...
    # send ping response from hbf-r and receive in vif3
    ...
    # Check if the ping request was sent at vif3 and received at hbf-l
    # Check if the ping request was sent at hbf-r and received at vif4
    # Check if the ping response was sent at vif4 and received at hbf-r
    # Check if the ping response was sent at hbf-l and received at vif3
    vif = vr_interface_req()
