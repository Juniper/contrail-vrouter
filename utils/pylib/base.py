...
class Base(object):
    ...
    @classmethod
    def launch_vrouter_instance(self, dpdk_args=None):
    ...
    @classmethod
    def restart_vrouter_with_args(self, dpdk_args):
        os.system('kill -9 $(pidof contrail-vrouter-dpdk)')
        vtest_only = self.vr_args['vtest_only']
        self.vr_args['vtest_only'] = 0
        self.launch_vrouter_instance(dpdk_args)
        self.vr_args['vtest_only'] = vtest_only
