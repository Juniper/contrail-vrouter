...
vr_drop_stats_table[1].append_value = {branch = {prepend = ": " , value = function (val) return sandesh_op[val] end},
...
vr_drop_stats_table[3].append_value = {subtree = {prepend = ", Core: " , value = function (val) return tostring(val) end}}
