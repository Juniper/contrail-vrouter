...
nh_req_table[1].append_value = {branch = {prepend = ": " , value = function (val) return sandesh_op[val] end},
                                subtree = {prepend = ", Operation: ", value = function (val) return sandesh_op[val] end}}
...
nh_req_table[2].append_value = {branch = {prepend = ": " , value = function (val) return nhr_type[val] end},
                                subtree = {prepend = ", Type: ", value = function (val) return nhr_type[val] end}}
...
nh_req_table[3].append_value = {branch = {prepend = ": " , value = function (val) return family[val] end}}

nh_req_table[4] = {}
nh_req_table[4].field_name = "nhr_id"
nh_req_table[4].ProtoField = ProtoField.int32
nh_req_table[4].base = base.DEC
nh_req_table[4].append_value = {subtree = {prepend = ", ID: " , value = function (val) return tostring(val) end}}
