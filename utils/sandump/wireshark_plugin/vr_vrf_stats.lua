...
vr_vrf_stats_table[1].append_value = {branch = {prepend = ": " , value = function (val) return sandesh_op[val] end},
...
vr_vrf_stats_table[3].append_value = {branch = {prepend = ": " , value = function (val) return family[val] end}}
...
vr_vrf_stats_table[5].append_value = {subtree = {prepend = ", Vrf: " , value = function (val) return tostring(val) end}}
