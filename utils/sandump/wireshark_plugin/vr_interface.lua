...
vif_req_table[1].append_value = {branch = {prepend = ": " , value = function (val) return sandesh_op[val] end}}
...
vif_req_table[3].append_value = {branch = {prepend = ": " , value = function (val) return vif_type[val] end},
                                subtree = {prepend = ", Type: ", value = function (val) return vif_type[val] end}}
...
vif_req_table[6].append_value = {subtree = {prepend = ", ID: " , value = function (val) return val end}}
...
vif_req_table[10].append_value = {subtree = {prepend = ", Name: ", value = function (val) return val end}}
...
vif_req_table[53].append_value = {branch = {prepend = ": " , value = function (val) return vif_transport[val] end}}
