...
vr_vrf_assign_table[1].append_value = {branch = {prepend = ": " , value = function (val) return sandesh_op[val] end},
...
vr_vrf_assign_table[3].append_value = {subtree = {prepend = ", ID: " , value = function (val) return tostring(val) end}}
...
vr_vrf_assign_table[4].append_value = {subtree = {prepend = ", Vrf: " , value = function (val) return tostring(val) end}}
