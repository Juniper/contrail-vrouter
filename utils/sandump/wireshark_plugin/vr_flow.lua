vr_flow_action = {}
vr_flow_action["0x00000000"] = "Drop"
vr_flow_action["0x00000001"] = "Hold"
vr_flow_action["0x00000002"] = "Forward"
vr_flow_action["0x00000003"] = "Nat"
...
vr_flow_flags1 = {}
vr_flow_flags1["0x100"] = "VR_FLOW_FLAG1_HBS_LEFT"
vr_flow_flags1["0x200"] = "VR_FLOW_FLAG1_HBS_RIGHT"
...
vr_flow_table[1].append_value = {branch = {prepend = ": " , value = function (val) return flow_op[val] end},
                                subtree = {prepend = ", Operation: ", value = function (val) return flow_op[val] end}}
...
vr_flow_table[3].append_value = {subtree = {prepend = ", ID: " , value = function (val) return tostring(val) end}}
...
vr_flow_table[4].append_value = {branch = {prepend = ": " , value = function (val) return vr_flow_action[val] end},
                                subtree = {prepend = ", Action: ", value = function (val) return vr_flow_action[val] end}}
...
vr_flow_table[7].append_value = {branch = {prepend = ": " , value = function (val) return family[val] end}}
