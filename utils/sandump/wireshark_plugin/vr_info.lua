...
vr_info_table[1].append_value = {branch = {prepend = ": " , value = function (val) return sandesh_op[val] end},
...
vr_info_table[3].append_value = {subtree = {prepend = ", ID: " , value = function (val) return tostring(val) end}}
...
vr_info_table[8].ProtoField = ProtoField.bytes
vr_info_table[8].base = base.SPACE

vr_info_table[9] = {}
vr_info_table[9].field_name = "vdu_proc_info"
vr_info_table[9].ProtoField = ProtoField.bytes
vr_info_table[9].base = base.SPACE
