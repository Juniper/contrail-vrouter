...
vr_mpls_table[1].append_value = {branch = {prepend = ": " , value = function (val) return sandesh_op[val] end},
...
vr_mpls_table[2].append_value = {subtree = {prepend = ", Label: " , value = function (val) return tostring(val) end}}
...
vr_mpls_table[4].append_value = {subtree = {prepend = ", NHID: " , value = function (val) return tostring(val) end}}
