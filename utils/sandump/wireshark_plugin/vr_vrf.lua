...
vr_vrf_table[1].append_value = {branch = {prepend = ": " , value = function (val) return sandesh_op[val] end},
...
vr_vrf_table[3].append_value = {subtree = {prepend = ", ID: " , value = function (val) return tostring(val) end}}
...
vr_vrf_table[4].append_value = {subtree = {prepend = ", Flags: " , value = function (val) return tostring(val) end}}
