...
vr_vxlan_table[1].append_value = {branch = {prepend = ": " , value = function (val) return sandesh_op[val] end},
...
vr_vxlan_table[3].append_value = {subtree = {prepend = ", VNID: " , value = function (val) return tostring(val) end}}
...
vr_vxlan_table[4].append_value = {subtree = {prepend = ", NHID: " , value = function (val) return tostring(val) end}}
