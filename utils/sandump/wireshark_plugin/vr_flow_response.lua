...
vr_flow_resp_table[1].append_value = {branch = {prepend = ": " , value = function (val) return flow_op[val] end},
...
vr_flow_resp_table[4].append_value = {subtree = {prepend = ", ID: " , value = function (val) return tostring(val) end}}
