...
static int help_set, bond_set, lacp_set, mempool_set, stats_set,  sock_dir_set;
...
{
    if(!(bond_set || lacp_set || mempool_set || stats_set))
        Usage();
...
main(int argc, char *argv[])
{
    ...
    while (((opt = getopt_long(argc, argv, "h:b:l:m:s:n:",
