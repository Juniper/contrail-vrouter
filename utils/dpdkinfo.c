...
static int help_set, bond_set, lacp_set, mempool_set, stats_set, xstats_set, lcore_set, sock_dir_set;
...
Usage()
{
    ...
    printf("                 --lacp|-l <conf/stat/all> Show LACP information from DPDK\n");
    printf("                 --mempool|-m <all/<mempool-name>>  Show Mempool information\n");
    printf("                 --stats|-n <eth>  Show Stats information\n");
    printf("                 --xstats|-x < =all/ =0(Master)/ =1(Slave(0))/ =2(Slave(1))>  Show Extended Stats information\n");
    printf("                 --lcore|-c                       Show Lcore information\n");    
...
{
    if(!(bond_set || lacp_set || mempool_set || stats_set || xstats_set || lcore_set))
        Usage();
