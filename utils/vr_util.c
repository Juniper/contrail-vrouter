...
int
vr_send_dpdkutils_dump(struct nl_client *cl, unsigned int router_id,
        int marker, int buff_table_id, dpdkinfo_msginfo msginfo)
{
    vr_dpdk_info_req req;
    ...
    return vr_sendmsg(cl, &req, "vr_dpdk_info_req");
}
