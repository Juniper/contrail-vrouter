...
int vr_set_log_options_request(struct nl_client *cl, unsigned int router_id, int module)
{
    ...
    req.vo_log_mod_type = logger.log_module[module].console;
    req.vo_log_mod_level[module] = logger.log_module[module].level;
...
int vr_set_log_sizes_request(struct nl_client *cl, unsigned int router_id, int module, int level)
{
    ...
    logger.log_module[module].level_info[level].num_records*VR_LOG_ENTRY_LEN;
