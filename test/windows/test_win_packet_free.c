...
Test_WinPacketFreeTree_SetUp(void** state) {
    ...
    *state = tree;
    ...
    return Test_WinPacketFree_SetUp(state);
}

int
Test_WinPacketFreeTree_TearDown(void** state)
{
    PPACKETS packets = *state;
    ...
    return Test_WinPacketFree_TearDown(state);
}

void
Test_WinPacketFreeTree_SingleLowerChild(void **state)
{
    PPACKETS packets = *state;
    PPACKET_TREE tree = &packets->tree;
...
void
Test_WinPacketFreeTree_AllLowerChildrenOfOneUpperChild(void **state)
{
    PPACKETS packets = *state;
    PPACKET_TREE tree = &packets->tree;
...
void
Test_WinPacketFreeTree_AllLowerChildrenOfAllUpperChildren(void **state)
{
    PPACKETS packets = *state;
    PPACKET_TREE tree = &packets->tree;
    ...
    // assert_ptr_equal(Fake_WinPacketRawFreeCreated_Target(), tree->parent);
...
#define WinPacketFreeTree_UnitTest_(p, f) cmocka_unit_test_setup_teardown(p##f, p##SetUp, p##TearDown)
#define WinPacketFreeTree_UnitTest(f) WinPacketFreeTree_UnitTest_(Test_WinPacketFreeTree_, f)
...
int main(void) {
    const struct CMUnitTest tests[] = {
        ...
        WinPacketFreeTree_UnitTest(SingleLowerChild),
        WinPacketFreeTree_UnitTest(AllLowerChildrenOfOneUpperChild),
        WinPacketFreeTree_UnitTest(AllLowerChildrenOfAllUpperChildren),
    };
