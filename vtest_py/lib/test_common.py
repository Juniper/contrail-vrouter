...
class Testcase(object):
    ...
    def setUpClass(self, method):
        ...
        self.vr.launch_vrouter_instance()
...
class test_common_Testcase(Testcase, object):
    ...
    def launch_vrouter_instance(self):
        self.dpdk_binary_path = sb_path + '/debug/vrouter/dpdk/contrail-vrouter-dpdk'
        self.socket_dir = sb_path + '/debug/vrouter/utils/vtest_py_venv/var/run/vrouter'
        self.vtest_only = 0
        self.pid = 0
    ...
    def run(self):
        ...
        if cpid == 0:
            ...
            print(
                "Running cmd - taskset 0x1 %s --no-daemon --no-huge --vr_packet_sz 2048 "
                "--vr_socket_dir %s" %
