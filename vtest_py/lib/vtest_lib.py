...
class vtest:
    ...
    def create_pcap_req(input_pkt_list, input_if_idx,
                        output_pkt_list, output_if_idx, req_file, output_file=None):
        ...
        if (output_pkt_list is not None):
            exp_pcap_filename = req_file+".exp.pcap"
            ...
            try:
                ...
                if (output_pkt_list is not None):
                    if (output_file is not None):
                        fh.write("<pcap_output_file>" + output_file + "</pcap_output_file>")
    ...
    def send_recv_pkt_compare(self, tx_pkt_list, tx_if_idx, rx_pkt_list, rx_if_idx):
